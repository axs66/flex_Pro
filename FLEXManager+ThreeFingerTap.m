...
// - (void)handleThreeFingerLongPress:(UILongPressGestureRecognizer *)gestureRecognizer {
//     if (gestureRecognizer.state == UIGestureRecognizerStateBegan) {
//         [self toggleExplorer];
//     }
// }

// 将 +load 方法重命名为 flex_setupGesture
+ (void)flex_setupGesture {
    // 这里的代码现在是安全的，因为它会在 App 启动后被调用
    [self flex_findAndAddGestureToWindow];
}

// + (void)load {
//     // +load 方法，已经被移到 Tweak.xm 中
//     /*
...
+ (void)flex_findAndAddGestureToWindow {
