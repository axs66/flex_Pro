...
+ (NSArray<FLEXGlobalsEntry *> *)allEntries {
    static NSArray<FLEXGlobalsEntry *> *entries;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        entries = @[
            // System
            [FLEXGlobalsEntry
                entryWithNameFuture:^NSString *{ return @"系统日志"; }
                viewControllerFuture:^UIViewController *{
                    return [FLEXSystemLogViewController new];
                }
            ],
            [FLEXGlobalsEntry
                entryWithNameFuture:^NSString *{ return @"APNs"; }
                viewControllerFuture:^UIViewController *{
                    return [FLEXAPNSViewController new];
                }
            ],
        ];
    });
