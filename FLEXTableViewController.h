...
@property (nonatomic, assign) id<FLEXSearchResultsUpdating> searchDelegate;
...
@property (nonatomic, assign) id<FLEXSearchResultsUpdating> searchResultsUpdater;
...
/// 添加一个搜索控制器到表格视图中
/// @param controller 要添加的搜索控制器
- (void)addSearchController:(UISearchController *)searchController;
