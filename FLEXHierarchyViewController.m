...
// 将 weak 改为 assign 以兼容 MRC
@property (nonatomic, readonly, assign) id<FLEXHierarchyDelegate> hierarchyDelegate;
...
- (void)viewDidLoad {
    ...
    // 将 __weak 改为 __block 以兼容 MRC
    __block id<FLEXHierarchyDelegate> delegate = self.hierarchyDelegate;
